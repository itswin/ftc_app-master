 ...
 */
@Autonomous(name="Vuforia OpenCV", group="Vuforia")
...
//        colorDetector.setHsvColor(new Scalar(25,255,185));  // Blue detector, needs verification with beacon
        ...
        while(opModeIsActive()) {
            ...
            if(croppedImg != null && !isButtonHit) {
                // Find the color of the beacon you need to hit first
                if(hitRed) {
                    colorDetector.setHsvColor(new Scalar(180,240,240)); // Red detector, needs verification with beacon
                } else {
                    colorDetector.setHsvColor(new Scalar(25,255,185)); // Blue detector, needs verification with beacon
                ...
                // Find the color of the beacon you are not hitting second
                if(hitRed) {
                    colorDetector.setHsvColor(new Scalar(25,255,185)); // Blue detector, needs verification with beacon
                } else {
                    colorDetector.setHsvColor(new Scalar(180,240,240)); // Red detector, needs verification with beacon
                ...
                if (beaconToHitCenter != null && secondReferenceCenter != null) {
//                    hitBeaconButton(isLeft(beaconToHitCenter, secondReferenceCenter));
                ...
                // Find the color three times in a row before hitting it
